...
import io.ylab.monitoring.auth.in.AuthUserRegistrationInputRequest;
...
public class RegistrationCommandExecutor extends AbstractCommandExecutor {
    ...
    protected boolean doWork(AppCommand command) {
        ...
        UserRegistrationInputRequest request = new AuthUserRegistrationInputRequest(command.getOperands().get(1),
