...
class AdminReadingsMonthServletTest {
    @Mock
    ...
    AdminReadingsMonthServlet sut;

    @BeforeEach
    void setUp() throws IOException {
        sut = new AdminReadingsMonthServlet(objectMapper, userContext, monthInput, validationService);
